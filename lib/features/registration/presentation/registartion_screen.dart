              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      // BoxShadow(color: Config.violetClr, blurRadius: .7),
                    ],
                  ),
                  child: Column(
                    spacing: 5,
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                tile(txt: "Event Location", val: data.location),
                                tile(txt: "Event Date", val: data.eventDate),
                                tile(txt: "Description", val: data.description),
                              ],
                            ),
                          ),
                        ],
                      ...
                      tile(isIc: true, ic: Icons.mail_outline, val: data.email),
